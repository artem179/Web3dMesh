...
function initVideoplane() {
  var videoTexture = new THREE.VideoTexture(capture);

  var videoGeometry = new THREE.PlaneBufferGeometry( capture.videoWidth, capture.videoHeight );
  console.log("W,h", capture.videoWidth, capture.videoHeight);
  ...
  //videoMesh.position.set(0, 0, 310);
